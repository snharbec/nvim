  ...
  config = function()
    require("dashboard").setup({
      ...
      config = {
        ...
        shortcut = {
          { desc = ' Agenda', group = '@property', action = 'lua require("note_search.search").open_agenda_buffer()', key = 'a' },
          { desc = ' Recent', group = '@property', action = 'lua Snacks.picker.files()', key = 'f' },
          ...
          { desc = ' Session', group = '@property', action = 'SessionLoad', key = 's' },
          { desc = ' Config', group = '@property', action = 'lua Snacks.picker.files({ cwd = vim.fn.stdpath("config") })', key = 'c' },
